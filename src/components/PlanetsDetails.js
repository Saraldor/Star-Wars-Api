...
class PeopleDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      link: `https://swapi.dev/api/planets/${props.match.params.id}/`,
      content: {}
    };
  }
